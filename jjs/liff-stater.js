window.onload = function() {
    ...
    const defaultLiffId = "1655540742-qr7xrzOv"; // change the default LIFF value if you are not using a node server
...
function initializeApp() {
    ...
    if (!liff.isLoggedIn()) {
        ...
        sendMessageButton.textContent = 'Tidak dapat memesan pada external browser';
    }
...
function showLogin() {
    document.querySelector('.login-wrapper > h1').innerHTML = 'JAJAN SOLO';
    document.querySelector('.login-wrapper > p').innerHTML = 'Hai, Kamu dapat login Line untuk menggunakannya.';
